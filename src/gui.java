...
public class gui extends JFrame {
	...
	public gui() {
		...
		contentPane.setLayout(
				new MigLayout("", "[55.00px][256px][88.00][][][][128px][128px][128px][128px][128px][][][31.00][][9.00]", "[90px][][][128px][][128px,center][128px][][128px][][][][][][][]"));
		...
		contentPane.add(btnBrowse, "cell 1 3,alignx center");
		...
		contentPane.add(lblResImg_1, "cell 6 3,grow");
		...
		contentPane.add(lblResImg_2, "cell 7 3,grow");
		...
		contentPane.add(lblResImg_3, "cell 8 3,grow");
		...
		contentPane.add(lblResImg_4, "cell 9 3,grow");
		...
		contentPane.add(lblResImg_5, "cell 10 3,grow");
		...
		contentPane.add(lblSearchImg, "cell 1 5 1 2,grow");
		lblSearchImg.setBorder(loweredbevel);

		/*

		JLabel lblResImg_16 = new JLabel("Image 16");
		lblResImg_16.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_16, "cell 6 5,grow");
		lblResImg_16.setBorder(loweredbevel);

		JLabel lblResImg_17 = new JLabel("Image 17");
		lblResImg_17.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_17, "cell 7 5,grow");
		lblResImg_17.setBorder(loweredbevel);

		JLabel lblResImg_18 = new JLabel("Image 18");
		lblResImg_18.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_18, "cell 8 5,grow");
		lblResImg_18.setBorder(loweredbevel);

		JLabel lblResImg_19 = new JLabel("Image 19");
		lblResImg_19.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_19, "cell 9 5,grow");
		lblResImg_19.setBorder(loweredbevel);

		JLabel lblResImg_20 = new JLabel("Image 20");
		lblResImg_20.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_20, "cell 10 5,grow");
		lblResImg_20.setBorder(loweredbevel);


		JLabel lblResImg_21 = new JLabel("Image 21");
		lblResImg_21.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_21, "cell 6 6,grow");
		lblResImg_21.setBorder(loweredbevel);

		JLabel lblResImg_22 = new JLabel("Image 22");
		lblResImg_22.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_22, "cell 7 6,grow");
		lblResImg_22.setBorder(loweredbevel);

		JLabel lblResImg_23 = new JLabel("Image 23");
		lblResImg_23.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_23, "cell 8 6,grow");
		lblResImg_23.setBorder(loweredbevel);

		JLabel lblResImg_24 = new JLabel("Image 24");
		lblResImg_24.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_24, "cell 9 6,grow");
		lblResImg_24.setBorder(loweredbevel);

		JLabel lblResImg_25 = new JLabel("Image 25");
		lblResImg_25.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_25, "cell 10 6,grow");
		lblResImg_25.setBorder(loweredbevel);


		JLabel lblResImg_26 = new JLabel("Image 26");
		lblResImg_26.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_26, "cell 6 8,grow");
		lblResImg_26.setBorder(loweredbevel);

		JLabel lblResImg_27 = new JLabel("Image 27");
		lblResImg_27.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_27, "cell 7 8,grow");
		lblResImg_27.setBorder(loweredbevel);

		JLabel lblResImg_28 = new JLabel("Image 28");
		lblResImg_28.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_28, "cell 8 8,grow");
		lblResImg_28.setBorder(loweredbevel);

		JLabel lblResImg_29 = new JLabel("Image 29");
		lblResImg_29.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_29, "cell 9 8,grow");
		lblResImg_29.setBorder(loweredbevel);

		JLabel lblResImg_30 = new JLabel("Image 30");
		lblResImg_30.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_30, "cell 10 8,grow");
		lblResImg_30.setBorder(loweredbevel);
		 */


		JLabel lblResImg_6 = new JLabel("Image 6");
		lblResImg_6.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblResImg_6, "cell 6 5,grow");
		...
		contentPane.add(lblResImg_7, "cell 7 5,grow");
		...
		contentPane.add(lblResImg_8, "cell 8 5,grow");
		...
		contentPane.add(lblResImg_9, "cell 9 5,grow");
		...
		contentPane.add(lblResImg_10, "cell 10 5,grow");
		...
		contentPane.add(lblResImg_11, "cell 6 6,grow");
		...
		contentPane.add(lblResImg_12, "cell 7 6,grow");
		...
		contentPane.add(lblResImg_13, "cell 8 6,grow");
		...
		contentPane.add(lblResImg_14, "cell 9 6,grow");
		...
		contentPane.add(lblResImg_15, "cell 10 6,grow");
		...
		contentPane.add(lblQImg, "cell 0 9,alignx center");
		...
		contentPane.add(btnSearch, "cell 1 14,alignx center,growy");
		...
		contentPane.add(btnClear, "cell 8 14,grow");
